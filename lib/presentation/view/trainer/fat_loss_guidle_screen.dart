...
class FatLossGuideScreen extends StatefulWidget {
  ...
  @override
  State<FatLossGuideScreen> createState() => _FatLossGuideScreenState();
}

class _FatLossGuideScreenState extends State<FatLossGuideScreen> {
  final List<FatLossModel> items = [
    FatLossModel(
