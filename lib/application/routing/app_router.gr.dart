...
class AiPoweredNutritionRoute extends _i8.PageRouteInfo<void> {
  const AiPoweredNutritionRoute({List<_i8.PageRouteInfo>? children})
...
class DietPlannerRoute extends _i8.PageRouteInfo<void> {
  const DietPlannerRoute({List<_i8.PageRouteInfo>? children})
...
class GeneratedDietRoute extends _i8.PageRouteInfo<void> {
  const GeneratedDietRoute({List<_i8.PageRouteInfo>? children})
...
/// generated route for
/// [_i5.ScanMealScreen]
class ScanMealRoute extends _i8.PageRouteInfo<void> {
  const ScanMealRoute({List<_i8.PageRouteInfo>? children})
...
class ScanResultRoute extends _i8.PageRouteInfo<void> {
  const ScanResultRoute({List<_i8.PageRouteInfo>? children})
